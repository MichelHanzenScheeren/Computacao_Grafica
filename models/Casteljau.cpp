	...
	Ponto2d *p0, Ponto2d *p1, Ponto2d *p2, int precisao)
{
	 if (_distancia(p0, p1 ) <= precisao &&  _distancia(p1, p2) <= precisao) {
		...
		_curva.push_back(p2);
		 ...
		 Ponto2d *aux1 = new Ponto2d((p0->X + p1->X) / 2, (p0->Y + p1->Y) / 2);
		 Ponto2d *aux3 = new Ponto2d((p1->X + p2->X) / 2, (p1->Y + p2->Y) / 2);
		 Ponto2d *aux2 = new Ponto2d((aux1->X + aux3->X) / 2, (aux1->Y + aux3->Y) / 2);
	...
	Ponto2d *p0, Ponto2d *p1, Ponto2d *p2, Ponto2d *p3, int precisao)
{
		...
		&& _distancia(p2, p3) <= precisao)
	 {
		...
		_curva.push_back(p3);
		 ...
		 Ponto2d *l2 = new Ponto2d((p0->X + p1->X) / 2, (p0->Y + p1->Y) / 2);
		 Ponto2d *h = new Ponto2d((p1->X + p2->X) / 2, (p1->Y + p2->Y) / 2);
		 Ponto2d *r3 = new Ponto2d((p2->X + p3->X) / 2, (p2->Y + p3->Y) / 2);
		 Ponto2d *l3 = new Ponto2d((l2->X + h->X) / 2, (l2->Y + h->Y) / 2);
		 Ponto2d *r2 = new Ponto2d((h->X + r3->X) / 2, (h->Y + r3->Y) / 2);
		 Ponto2d *l4 = new Ponto2d((l3->X + r2->X) / 2, (l3->Y + r2->Y) / 2);
